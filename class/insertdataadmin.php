<?php 
		...
		function fill_item_select_box($connect)
		{
			...
			$query = "SELECT * FROM item_a WHERE a_type = 1 ORDER BY a_id ASC";
		...
		$j(document).ready(function(){
			...
			function add_input_field(count)
			{
				...
				html += '<td><select name="item_name[]" class="form-control selectpicker" data-live-search="true"><option value="">เลือกวัสดุ</option><?php echo fill_item_select_box($connect); ?></select></td>';
