      ...
      while($row = mysqli_fetch_array($result)){
          ...
          $unit = $row['name'];
            ...
            if($days == 3 or $days == -1 ){
              ...
              $mail->SMTPAuth = true;
              $mail->Username = 'logisticsrmuti22@gmail.com'; // Your gmail
              $mail->Password = 'jrfpjxfrecmwouzw'; // Your gmail app password
              $mail->SMTPSecure = 'ssl';
              $mail->Port = 465;
                          ...
                          <tbody>
                            <tr>
                              <td align='center' style='background-color: ##ffa73b;
                                  height: 150px;'>
                                  <img src='https://www.img.in.th/images/579a96423b77750c2ac10f6c631d681d.png' alt='Girl in a jacket' width='300' height='370'>
