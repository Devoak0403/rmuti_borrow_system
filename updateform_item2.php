  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">แก้ไขข้อมูลครุภัณฑ์</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index_admin.php">หน้าหลัก</a></li>
              <li class="breadcrumb-item"><a href="form_item.php">ข้อมูลครุภัณฑ์</a></li>
              <li class="breadcrumb-item active">แก้ไขข้อมูลครุภัณฑ์</li>
            </ol> 
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="sql/update_item1.php" method="POST">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">จำนวนคงคลัง</label>
                                <div class="col-sm-4">
