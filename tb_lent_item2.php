  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">ข้อมูลการเบิกครุภัณฑ์</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index_admin.php">หน้าหลัก</a></li>
              <li class="breadcrumb-item active">ข้อมูลการเบิกครุภัณฑ์</li>
            </ol> 
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                  ...
                  <table id="example1" class="table table-bordered table-striped" >
                    <thead>
                      ...
                      <?php
                                ...
                                * FROM item_a
                                INNER JOIN history ON item_a.a_key = history.item_id WHERE history.h_type = '2' ORDER BY history.h_id DESC");
                                $stmt1->execute();
                        ...
                        <tr>
                            ...
                            <td width="6%"><?= $row2['item_id'];?></td>
                            <td width="15%"><?= $row2['a_name'];?></td>
                            <td width="20%"><?= $row2['u_name'];?></td>
                            <td width="5%"><?= $row2['h_value'];?></td>
                            <td width="15%"><?=DateTimeThai($row2['lent_start']);?></td>
                            <td width="15%"><?=DateTimeThai($row2['lent_end']);?></td>
                            <td width="8%"><div align="center">
                              <?php
                              if($row2['status_id'] =='1'){
                                echo "<span class='badge badge-success text-md'>ยืม</span>";
                              } else if($row2['status_id'] =='2'){
                                echo "<span class='badge badge-info text-md'>คืน</span>";
                              } else if($row2['status_id'] =='3'){
                                echo "<span class='badge badge-danger text-md'>เกินกำหนด</span>";
                              }
                              ?>
                            </td>
                            <td  width="5%">
                              <a href="updateform_lent_item2.php?h_id=<?= $row2['h_id']; ?>" ><i class="fas fa-edit"></i></a>
